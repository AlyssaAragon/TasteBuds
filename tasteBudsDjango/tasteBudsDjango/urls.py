...
from tastebuds.views import (
    home, random_recipe, user_profile, filter_recipes_by_diet, LinkPartnerAPIView,
    get_random_recipe_by_category, filter_recipes_combined, ExemptLoginView, ExemptSignupView,
    api_signup, PrivateRecipeListCreateView, PrivateRecipeDetailView,
    get_partner_requests, respond_to_partner_request, remove_partner,
    update_user_diets, change_password
)
